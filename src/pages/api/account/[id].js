...
export default async function getContentsByAccountNotionID(req, res) {
    ...
    if (payload) {
        ...
        let data = await contentsRepo.getContentsByAccountNotionID(id, startCursor || undefined, pageSize || undefined)
        console.log(data)
